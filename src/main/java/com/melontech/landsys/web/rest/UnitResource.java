...
import com.melontech.landsys.service.UnitService;
...
/**
 * REST controller for managing {@link com.melontech.landsys.domain.Unit}.
 */
@RestController
@RequestMapping("/api")
public class UnitResource {
     ...
     */
    @GetMapping("/units")
    public ResponseEntity<List<UnitDTO>> getAllUnits(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
