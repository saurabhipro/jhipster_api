...
public class PaymentFileHeaderServiceImpl implements PaymentFileHeaderService {
    ...
    public Page<PaymentFileHeaderDTO> findAllWithEagerRelationships(Pageable pageable) {
        return paymentFileHeaderRepository.findAllWithEagerRelationships(pageable).map(paymentFileHeaderMapper::toDto);
    }
    ...
    public Optional<PaymentFileHeaderDTO> findOne(Long id) {
        ...
        return paymentFileHeaderRepository.findOneWithEagerRelationships(id).map(paymentFileHeaderMapper::toDto);
    }
