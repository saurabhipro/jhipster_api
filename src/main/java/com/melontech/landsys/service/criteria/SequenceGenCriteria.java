...
/**
 * Criteria class for the {@link com.melontech.landsys.domain.SequenceGen} entity. This class is used
 * in {@link com.melontech.landsys.web.rest.SequenceGenResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /sequence-gens?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class SequenceGenCriteria implements Serializable, Criteria {
    ...
    public SequenceGenCriteria() {}

    public SequenceGenCriteria(SequenceGenCriteria other) {
    ...
    @Override
    public SequenceGenCriteria copy() {
        return new SequenceGenCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final SequenceGenCriteria that = (SequenceGenCriteria) o;
        return (
